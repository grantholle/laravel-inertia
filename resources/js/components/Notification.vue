<template>
  <div class="w-full bg-white mt-4 shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden">
    <div class="p-4">
      <div class="flex items-start">
        ...
        <div class="ml-3 w-0 flex-1 pt-0.5">
          ...
          <p v-html="notification.text" class="mt-1 text-sm text-gray-500"></p>
        </div>
        <div class="ml-4 flex-shrink-0 flex">
          <!-- Close icon -->
          <button @click.prevent="removeNotification(notification.id)" class="p-0.5 bg-white rounded-full inline-flex text-gray-400 hover:text-gray-500 hover:bg-gray-50 focus:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300">
